...
smart_actions.append(ACTION_ATTACK + '_' + str(5) + '_' + str(5))
smart_actions.append(ACTION_ATTACK + '_' + str(5) + '_' + str(58))
smart_actions.append(ACTION_ATTACK + '_' + str(58) + '_' + str(5))
smart_actions.append(ACTION_ATTACK + '_' + str(58) + '_' + str(58))
smart_actions.append(ACTION_ATTACK + '_' + str(30) + '_' + str(30))
...
class SparseAgent(base_agent.BaseAgent):
    ...
    def step(self, obs):
        ...
        if self.move_number == 0:
            ...
            excluded_actions = []
            if worker_supply == 0:#'''supply_depot_count == 2 or''' 
                excluded_actions.append(1)
                
            if supply_depot_count == 0 or worker_supply == 0:# ''' barracks_count == 2 or'''
